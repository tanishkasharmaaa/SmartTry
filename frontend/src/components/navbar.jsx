import { Box, Heading, Text, IconButton, Drawer, DrawerBody, DrawerHeader, DrawerOverlay, DrawerContent, DrawerCloseButton, useDisclosure } from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      <Box
        ...
        px={{ base: 4, md: 10 }}
        py={3}
        bg="linear-gradient(90deg, rgba(5, 5, 5, 0.75), rgba(135, 135, 135, 0.15))"
